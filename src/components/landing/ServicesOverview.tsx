      ...
      <div className="container-narrow">
        ...
        >
          <Tabs defaultValue="consultation" className="w-full">
            <TabsList className="grid w-full grid-cols-1 md:grid-cols-4 h-auto gap-2 bg-transparent p-0 mb-8">
              {["consultation", "recovery", "training", "ai"].map((tab, i) => (
              ...
              >
                <div className={`grid ${isMobile ? 'grid-cols-1' : 'md:grid-cols-2'} gap-8 items-center`}>
                  <div>
                    ...
                    <p className="text-muted-foreground">
                      We connect you with trusted care centers and provide guidance
                  ...
                  {!isMobile && (
                    ...
                    >
                      <img
                        ...
                        alt="Trusted recovery support facility"
                        className="w-full h-64 md:h-80 object-cover"
                      />
                    </motion.div>
                  )}
            ...
            <TabsContent value="ai" className="mt-0">
              ...
              >
                <div className={`grid ${isMobile ? 'grid-cols-1' : 'md:grid-cols-2'} gap-8 items-center`}>
                  <div>
                    <h3 className="text-2xl font-bold text-card-foreground mb-4">
                      DovesMind AI Assistant
                    </h3>
                    <p className="text-muted-foreground">
                      An intelligent companion providing instant support, resources, and guidance
                      for mental wellness and substance abuse queries.
                    </p>
                    {!isMobile && (
                      <ul className="space-y-3 mt-6">
                        {[
                  ...
                  {!isMobile && (
                    <motion.div
                      className="rounded-xl overflow-hidden bg-gradient-to-br from-dove-teal/20 to-accent/20 flex items-center justify-center h-64 md:h-80"
                      whileHover={{ scale: 1.02 }}
                      transition={{ duration: 0.3 }}
                    >
                      <MessageCircle className="h-24 w-24 text-dove-teal opacity-50" />
                    </motion.div>
                  )}
                </div>
              </motion.div>
